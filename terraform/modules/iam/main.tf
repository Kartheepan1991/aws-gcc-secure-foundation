# IAM Module - Roles and policies for EKS, CI/CD and runtime
# Implements least privilege access for GCC compliance
...
# CI/CD Role - Used by GitHub Actions for deployment
...
# CI/CD Policy - Permissions for deployment pipeline
